...
export const UsersSchemaZod = UserSchemaZod.array().describe(
  'The list of User objects'
)

export const UsersQueryZod = UserSchemaZod.partial().describe(
  'Fields of user schema that can be used to query the list of users'
)
...
export const CreateUserBodyZod = UserSchemaZod.pick({
  id: true,
  name: true
}).describe('User details to be used for user creation')
...
export const UpdateUserBodyZod = UserSchemaZod.pick({
  ...
  .partial()
  .describe('User details to be used for user update')
...
export const DeleteUserQueryZod = StrictObject.extend({
  hardDelete: CoercedBoolean
})
  .partial()
  .optional()
  .describe('Query parameters to set user deletion settings')
...
}).describe('Base Link schema')

export const LinksSchemaZod = LinkSchemaZod.array().describe('List of Links')

export const LinksQueryZod = LinkSchemaZod.partial().describe(
  'Properties to search the list of Links by'
)
...
export const CreateLinkBodyZod = LinkSchemaZod.pick({
  ...
  .describe('Properties to create Link by')
...
export const UpdateLinkBodyZod = CreateLinkBodyZod.pick({
  ...
  .describe('Properties to update Link by')
